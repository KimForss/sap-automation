...
resource "azurerm_network_security_group" "nsg_app" {
  ...
  count                                = local.enable_deployment ? (var.infrastructure.virtual_networks.sap.subnet_app.nsg.exists ? 0 : 1) : 0
...
data "azurerm_network_security_group" "nsg_app" {
  provider                             = azurerm.main
  count                                = local.enable_deployment ? (var.infrastructure.virtual_networks.sap.subnet_app.nsg.exists ? 1 : 0) : 0
