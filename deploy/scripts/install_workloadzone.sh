...
terraform -chdir="${terraform_module_directory}" state show 'module.sap_landscape.azurerm_storage_account.storage_bootdiag[0]'
terraform -chdir="${terraform_module_directory}" state list | grep module.sap_landscape.azurerm_storage_account.storage_bootdiag[0]
terraform -chdir="${terraform_module_directory}" state list | grep 'module.sap_landscape.azurerm_storage_account.storage_bootdiag[0]'
terraform -chdir="${terraform_module_directory}" state list | grep "module.sap_landscape.azurerm_storage_account.storage_bootdiag[0]"
exit 0
