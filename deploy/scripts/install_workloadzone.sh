...
then
    ...
    then
        ...
        for item in "${existing_resources[@]}"; do
            ...
            resourceGroupID=$(echo $resourceID | awk '{split($0,a,"\""); print  a[5]}' ); echo "ResourceGroupId: $resourceGroupID"
            subscriptionID=$(echo $resourceID | awk '{split($0,a,"\""); print  a[3]}' ); echo "SubscriptionId:  $subscriptionID"
            accountID=$(echo $resourceID | awk '{split($0,a,"\""); print  a[7]}' ) ; echo "AccountID: " $accountID"
